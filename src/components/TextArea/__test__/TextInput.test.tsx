...
describe('components > TextInput', () => {
  it('valid', async () => {
    ...
    const {getByTestId, queryByTestId} = render(<TextInput name="email" value="test" onChange={mockChange} />);
  ...
  it('invalid', () => {
    ...
    const {getByTestId} = render(
      <TextInput name="email" invalidMessage="invalid message" value="test" onChange={mockChange} />,
    );
